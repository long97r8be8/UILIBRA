...
local ItemsTab = sitinkgui:MakeTab("Items")
local StatsTab = sitinkgui:MakeTab("Stats")
local TeleportTab = sitinkgui:MakeTab("Teleport")
local ShopTab = sitinkgui:MakeTab("Shop")
local MiscTab = sitinkgui:MakeTab("Misc")
}
